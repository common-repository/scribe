...
if(empty($properKeywords)) {
	?>
	<p>
		<?php _e('No Primary, Important, or Significant keywords found.', 'scribe'); ?>
	</p>
	<?php
} else {
	?>
	...
	<div id="scribe-content-keywords-container">
		<p><strong><?php _e('Click a keyword below to see alternate suggestions.', 'scribe'); ?></strong></p>
	...
	<div id="scribe-alternate-keywords">
		<table class="widefat" style="display:none;" id="fetching-alternate-keywords-message">
			<thead>
				<tr>
					<th scope="col"><?php _e('Fetching alternate keywords...', 'scribe'); ?></th>
				</tr>
			</thead>
			<tbody></tbody>
		</table>
