...
if ($keywordAlternates != null) {
	...
	$no_data = true;
	$no_data_text = __('No alternate keywords found', 'scribe');
	$denom = 1;
}
?>
<table class="widefat alternate-keywords-table">
	<thead>
		<tr>
			<th scope="col"><?php esc_html_e('Alternate Keyword Suggestions', 'scribe'); ?></th>
			<th scope="col"><?php esc_html_e('Relative Search Frequency', 'scribe'); ?></th>
		</tr>
	</thead>
	<tfoot>
		<tr>
