...
<form method="post">
	...
	<table class="widefat" style="width:99%" id="ecordia-analysis-score-table">
		<thead>
			<tr>
				<th scope="col"><?php esc_html_e( 'Overall' , 'scribe'); ?></th>
				<th scope="col"><?php esc_html_e( 'Content' , 'scribe'); ?></th>
				<th scope="col"><?php esc_html_e( 'Analysis &amp; Recommendations' , 'scribe'); ?></th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td id="ecordia-score-analysis-overview" class="ecordia-middle-cell <?php echo sanitize_html_class( $this->getSeoScoreClassForPost( $scoreInfo['Score']['Value'] ) ); ?>-background" rowspan="<?php echo esc_attr( $sectionCount ); ?>">
					<div id="overall-score-analysis"><?php printf( esc_html__( '%d%%' , 'scribe'), $scoreInfo['Score']['Value']); ?></div>
