<div class="scribe-wrap">
	<div class="scribe-link-building-tabs scribe-link-building-keyword-section">
			<div class="scribe-link-building-tip-visible">
				...
				<p><?php printf( __( 'Like linking to external websites (using the %s tool), you can (and should) regularly use the authority of your own best content to link <em>internally</em>, to your own pages.', 'scribeseo' ), '<a href="' . admin_url( 'admin.php?page=scribe-connections' ) . '" target="_blank">' . __( 'Scribe Site Connector', 'scribeseo' ) . '</a>' ); ?></p>

				<p><?php _e( 'What should you link to? Again, to your best content — what we call your <em>cornerstone content</em>. Your best advice, your best thinking, and your best answers to the questions your audience comes up with again and again.', 'scribeseo' ); ?></p>

				<p><?php _e( 'Use <em>Scribe’s Internal Links function</em> to find and <a href="http://www.copyblogger.com/seo-site-quality/" target="_blank">link to that best content on your own site</a>, and make it work <em>for you</em> again and again.', 'scribeseo' ); ?></p>
			</div>
