...
?>
	...
	public function enqueue_admin_css( $hook = '' ) {
		...
		if ( 'toplevel_page_scribe-settings' != $hook )
			return;
		...
		wp_enqueue_script('scribe-backend', SCRIBE_PLUGIN_URL . 'resources/backend/scribe.js', array('jquery', 'thickbox', 'jquery-ui-tabs', 'scribe-jqplot', 'suggest'), Scribe_SEO::VERSION);

		Scribe_SEO::add_configuration_script();
