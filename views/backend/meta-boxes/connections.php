	...
	<div class="scribe-link-building-tabs" data-link-building-complete="false">
		<div class="scribe-link-building-tab-section" id="scribe-link-building-difficulty">
			...
			<div class="scribe-link-building-tip">
				<p><strong><?php _e( 'It’s Time to Become the “Likeable Expert” in Your Niche', 'scribeseo' ); ?></strong></p>

				<p><?php _e( 'The human brain is wired to seek out authority. One powerful way authority is demonstrated online is through <em>who’s linking to your content</em>.', 'scribeseo' ); ?></p>

				<p><?php _e( 'Use <em>Scribe’s Difficulty Score</em> to determine how likely it is that another online publisher will link to you—the higher your score, the harder it will be earn external links … the lower your score, the easier.', 'scribeseo' ); ?></p>

				<p><a href="http://www.copyblogger.com/content-marketing/" target="_blank"><?php _e( 'Click here', 'scribeseo' ); ?></a> <?php _e( 'to study a few useful tutorials that’ll help you write the kind of content your audience is looking for.', 'scribeseo' ); ?></p>
			</div>
		...
		<div class="scribe-link-building-tab-section" id="scribe-link-building-external-links">
			...
			<a class="scribe-tip-marker scribe-hide-tip scribe-link-building-tip" href="#">-</a>
			<div class="scribe-link-building-tip">
				<p><strong><?php _e( 'Two Simple Strategies for Building External Links to Your Website', 'scribeseo' ); ?></strong></p>

				<p><?php _e( 'Links coming to your site from other authoritative sites are crucial to your ranking in search engines. But how do you get those links when nobody knows who you are?', 'scribeseo' ); ?></p>

				<p><?php _e( '<em>Scribe’s External Links function</em> shows you—and even gives you the available <em>contact information</em> of— websites that are ranking well for the keywords in your post.', 'scribeseo' ); ?></p>

				<p><?php printf( __( 'Use it to execute two simple and powerful strategies for building external links: 1) Head over to one of the sites and %s, and 2) Contact the site owner with an %s for them, using the very best content you’ve written.', 'scribeseo' ), '<a href="http://www.copyblogger.com/blog-comment-traffic/" target="_blank">' . __( 'leave a relevant, smart comment', 'scribeseo' ) . '</a>', '<a href="http://www.copyblogger.com/successful-guest-blogging/" target="_blank">' . __( 'offer to guest post', 'scribeseo' ) . '</a>' ); ?></p>
			</div>
		...
		<div class="scribe-link-building-tab-section" id="scribe-link-building-social-media">
			...
			<a class="scribe-tip-marker scribe-hide-tip scribe-link-building-tip" href="#">-</a>
			<div class="scribe-link-building-tip">
				<p><strong><?php _e( 'Harness the Nearly Unlimited Networking Power of Social Networks', 'scribeseo' ); ?></strong></p>

				<p><?php _e( 'The rise of social networking sites like Twitter, Facebook and Google+ has created the most powerful research and connection engine in history. With just a few clicks, you can read the innermost thoughts of the famous, or (more importantly) the desires, needs, and fears of your potential audience.', 'scribeseo' ); ?></p>

				<p><?php _e( 'But how do you make sense of this firehose of information? The <em>Scribe Social Media function</em> does a lot of that for you.', 'scribeseo' ); ?></p>

				<p><?php printf( __( 'Based on the keywords of your post, Scribe will seek out and display the relevant people and the discussions they’re having right now, so you can %s and %s.', 'scribeseo' ), '<a href="http://www.copyblogger.com/social-media-networking/" target="_blank">' . __( 'join the conversation', 'scribeseo' ) . '</a>', '<a href="http://www.copyblogger.com/social-media-relationships/" target="_blank">' . __( 'engage your audience', 'scribeseo' ) . '</a>' ); ?></p>
			</div>
