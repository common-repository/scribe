					...
					<td>
						...
						?>
							<li><span>
								...
								<?php _e( 'The Flesch Score describes comprehension difficulty for a passage of text.', 'scribeseo' ); ?><br />
								<?php printf( esc_html__( 'The Flesch score for this page is: %s', 'scribeseo'), '<strong>' . esc_html( ucwords( $content_analysis->fleschScore ) ) . '</strong>' ); ?>
							</span></li>
						</ul>
					</td>
				</tr>
