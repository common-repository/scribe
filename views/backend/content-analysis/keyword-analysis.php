...
<p><?php _e( 'The four quadrants (A, B, C, and D) show a comparison of how well the keywords Scribe found in your content will perform, based on two metrics:', 'scribeseo' ); ?></p>

<ul>
    <li><?php _e( '1. How well is the content optimized for the keyword?', 'scribeseo' ); ?></li>
    <li><?php _e( '2. How well is the site where the content will be published optimized for the keyword?', 'scribeseo' ); ?></li>
</ul>

<p><?php _e( 'Here\'s a few details regarding what each quadrant means:', 'scribeseo' ); ?></p>

<p><?php _e( '<strong>A -</strong> The page and site are superbly optimized for the keyword used; this is the holy grail. <em>Example</em>: Copyblogger.com publishing an article that is well optimized for the term "copywriting."', 'scribeseo' ); ?></p>

<p><?php _e( '<strong>B -</strong> The page is not well optimized for the keyword, but the site is. Optimize the page for the keyword and the keyword should move into the A quadrant. <em>Example</em>: Copyblogger.com publishing an article that is not well optimized for the term "copywriting."', 'scribeseo' ); ?></p>

<p><?php _e( '<strong>C -</strong> The page is optimized for the keyword, but the site is not. This may be a new site or a new keyword that you\'re targeting. It will take some time to get more optimized content published for this keyword to eventually move the keyword to quadrant A. <em>Example</em>: Copyblogger.com publishing an article that is optimized for the keyword "pizza."', 'scribeseo' ); ?></p>

<p><?php _e( '<strong>D -</strong> Neither the site nor the page are optimized for the keyword. This may be a new site. Start by optimizing the page for the keyword in order to move it into the C quadrant and then publish more optimized content over time to eventually move it to the A quadrant. <em>Example</em>: Copyblogger.com publishing an article that is not well optimized for the keyword "pizza."', 'scribeseo' ); ?></p>
			</div>
			<div class="clear"></div>
		</div>
	...
	<div class="scribe-keyword-analysis-details">
		...
		<table class="widefat scribe-keyword-analysis-details-table">
			<thead>
				<tr valign="top">
					<th scope="col" class="scribe-keyword-analysis-details-table-keyword"><?php _e('Keyword', 'scribeseo'); ?></th>
					<th scope="col" class="scribe-keyword-analysis-details-table-score"><?php _e('Grade', 'scribeseo'); ?></th>
					<th scope="col" class="scribe-keyword-analysis-details-table-rank"><?php _e('Rank', 'scribeseo'); ?></th>
					<th scope="col" class="scribe-keyword-analysis-details-table-prominence"><?php _e('Prominence', 'scribeseo'); ?></th>
					<th scope="col" class="scribe-keyword-analysis-details-table-frequency"><?php _e('Frequency', 'scribeseo'); ?></th>
					<th scope="col" class="scribe-keyword-analysis-details-table-density"><?php _e('Density', 'scribeseo'); ?></th>
					<th scope="col" class="scribe-keyword-analysis-details-table-volume"><?php _e('Monthly Search Volume', 'scribeseo'); ?></th>
				</tr>
			</thead>
			<tfoot>
				<tr valign="top">
